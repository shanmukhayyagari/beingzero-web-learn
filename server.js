...
app.get('/crud', isAuthenticated, function(req, res) {
...
app.get('/google', isAuthenticated, function(req, res) {
    let fullFilePath = __dirname + "/frontend/html/google.html";
    res.sendFile(fullFilePath);

});

app.get('/color', isAuthenticated, function(req, res) {
...
app.get('/tambola', isAuthenticated, function(req, res) {
